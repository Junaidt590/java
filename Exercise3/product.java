...
if(obj3.price<obj1.price && obj3.price<obj2.price)  
  System.out.println("\n Product code= " +obj3.pcode+" , Product name= "+obj3.pname+ " , price="+obj3.price);            
	...
	OUTPUT
	______
	Enter person 1  pcode,pname,price: 1 gold 40000
	Enter person 2  pcode,pname,price: 2 silver 20000
	Enter person 3  pcode,pname,price: 3 platinum 10000

 	Product code= 3 , Product name= platinum , price=10000
